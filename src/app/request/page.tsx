...
export default function RequestPage() {
    ...
    return (
        <motion.div
            className="pt-20 pb-24 md:pb-12 min-h-screen gradient-eco-soft"
            animate={confirming ? { opacity: 0, scale: 0.95 } : { opacity: 1, scale: 1 }}
